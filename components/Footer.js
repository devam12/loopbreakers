        ...
        <footer style={{backgroundImage:`url('https://wpolive.com/html/manit-html/assets/images/footer-bg.jpg')`}}>
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">LoopBreakers™</a>. All Rights Reserved.
                    </span>
