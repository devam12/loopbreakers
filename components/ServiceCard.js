...
export default function ServiceCard({ title, desc, link = "#", svgcolor = "red", svgicon }) {
    return (
        <div className=" flex flex-col relative bg-white text-black rounded-md p-5 w-fit justify-center mb-12 drop-shadow-2xl">
            ...
            <span className="text-white absolute top-0 right-0 w-20 h-full z-10 transform translate-x-2 -translate-y-5 text-4xl font-bold">01</span>
